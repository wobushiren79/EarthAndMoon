...
public class Moon {
    ...
    public void bindData(MoonShaderProgram moonShaderProgram) {
        vertexArrary.setData(0, moonShaderProgram.getPositionLocation(), 3, 3 * 4);
        vertexArraryTexture.setData(0, moonShaderProgram.getTextureLocation(), 2, 2 * 4);
        vertexArraryNormal.setData(0, moonShaderProgram.getNormalLocation(), 3, 3 * 4);
    }
